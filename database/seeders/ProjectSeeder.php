...
class ProjectSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Project::create([
            ...
            'description' => 'Cómo los grandes filósofos pueden estimular nuestro pensamiento crítico - José Carlos Ruiz',
        ]);
        ...
        Project::create([
            ...
            'name' => 'Medio rey',
            'description' => 'Primer libio de la saga _El mar quebrado_ - Joe Abercrombie',
        ]);
    }
}
