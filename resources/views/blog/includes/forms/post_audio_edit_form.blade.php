<form 
id="post-audio-edit-form" 
action="{{ route('blog.post_audio.update', ['id' => $postAudio->id]) }}"
method="post" 
novalidate
>
...
type="text" 
name="audio_url" 
value="{{ old('audio_url', $postAudio->audio_url) }}"
required="required"
>
</div>
